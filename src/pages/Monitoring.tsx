...
+        `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/logs/monitor/export${selectedServer ? `?serverId=${selectedServer}` : ''}`,
+        {
+          headers: {
...
+      a.href = url;
+      a.download = `assurnet-monitoring-${new Date().toISOString().split('T')[0]}.csv`;
