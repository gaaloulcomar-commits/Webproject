...
+  };
   ...
   const handleSubmit = async (e: React.FormEvent) => {
     ...
     try {
       ...
       loadServers();
+      loadGroups(); // Refresh groups in case new one was added
       resetForm();
     } catch (error) {
     ...
     <div className="space-y-6">
       <div className="flex justify-between items-center">
         <div>
           ...
           <p className="text-gray-400">Manage your server configurations</p>
         </div>
         <button
               ...
               <div className="grid grid-cols-2 gap-4">
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => setFormData({ ...formData, restartOrder: parseInt(e.target.value) })}
                     className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                   />
                 </div>
                 ...
                 <div>
                   ...
                   <input
                     ...
                     onChange={(e) => setFormData({ ...formData, restartDelay: parseInt(e.target.value) })}
                     className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                   />
                 </div>
               </div>
